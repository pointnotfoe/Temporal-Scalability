...
class ICodec
{
 ...
 protected:
  ...
  float *f_new[16];
  //--------------
  int **m_iMVy, **m_iMVx, **p_iMVy, **n_iMVy, **p_iMVx, **n_iMVx; /////added
...
class IEncoder:public ICodec
{
 public:
  ...
  int GetSAD(
    ...
    void predict_B(float **pfCurrFrame, float **pfRefFrame, float **pfNewFrame);/////added
	void hireacrical_prediction();/////added
  void EncodeMV();
